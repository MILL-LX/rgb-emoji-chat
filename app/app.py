...
SERVICE_PORT = 3000 if is_raspberry_pi() else 8080 #TODO: probably run on port 80 when deployed
...
if __name__ == '__main__':
    ...
    socketio.run(app, host=host, port=SERVICE_PORT, allow_unsafe_werkzeug=True)
